...
gcc -g simple_tests.c Gen_Table/gen_table.c Groups/group.c Algorithms/snf.c Algorithms/algs.c Algorithms/jules.c Garbage_Collector/garbage_collector.c Linked_List/linked_list.c -o TESTS
